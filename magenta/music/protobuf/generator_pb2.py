...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=_b(
        ...
        '\t\"\x89\x04\n\x10GeneratorOptions\x12L\n\x0einput_sections\x18\x01 \x03('
        '\x0b\x32\x34.tensorflow.magenta.GeneratorOptions.SequenceSection\x12O\n\x11generate_sections\x18\x02 \x03('
        '\x0b\x32\x34.tensorflow.magenta.GeneratorOptions.SequenceSection\x12<\n\x04\x61rgs\x18\x03 \x03('
        '\x0b\x32..tensorflow.magenta.GeneratorOptions.ArgsEntry\x1a\x37\n\x0fSequenceSection\x12\x12\n\nstart_time'
        '\x18\x01 \x01(\x01\x12\x10\n\x08\x65nd_time\x18\x02 \x01('
        '\x01\x1a\x82\x01\n\x08\x41rgValue\x12\x14\n\nbyte_value\x18\x01 \x01(\x0cH\x00\x12\x13\n\tint_value\x18\x02 '
        '\x01(\x05H\x00\x12\x15\n\x0b\x66loat_value\x18\x03 \x01(\x01H\x00\x12\x14\n\nbool_value\x18\x04 \x01('
        '\x08H\x00\x12\x16\n\x0cstring_value\x18\x05 \x01('
        '\tH\x00\x42\x06\n\x04kind\x1aZ\n\tArgsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12<\n\x05value\x18\x02 \x01('
        '\x0b\x32-.tensorflow.magenta.GeneratorOptions.ArgValue:\x02\x38\x01\"\xf4\x01\n\x0fGeneratorBundle\x12?\n'
        '\x11generator_details\x18\x01 \x01(\x0b\x32$.tensorflow.magenta.GeneratorDetails\x12I\n\x0e\x62undle_details'
        '\x18\x04 \x01(\x0b\x32\x31.tensorflow.magenta.GeneratorBundle.BundleDetails\x12\x17\n\x0f\x63heckpoint_file'
        '\x18\x02 \x03(\x0c\x12\x16\n\x0emetagraph_file\x18\x03 \x01('
...
_GENERATOROPTIONS_ARGVALUE.fields_by_name['byte_value'].containing_oneof = _GENERATOROPTIONS_ARGVALUE.oneofs_by_name[
    'kind']
_GENERATOROPTIONS_ARGVALUE.oneofs_by_name['kind'].fields.append(
    _GENERATOROPTIONS_ARGVALUE.fields_by_name['int_value'])
_GENERATOROPTIONS_ARGVALUE.fields_by_name['int_value'].containing_oneof = _GENERATOROPTIONS_ARGVALUE.oneofs_by_name[
    'kind']
_GENERATOROPTIONS_ARGVALUE.oneofs_by_name['kind'].fields.append(
    _GENERATOROPTIONS_ARGVALUE.fields_by_name['float_value'])
_GENERATOROPTIONS_ARGVALUE.fields_by_name['float_value'].containing_oneof = _GENERATOROPTIONS_ARGVALUE.oneofs_by_name[
    'kind']
_GENERATOROPTIONS_ARGVALUE.oneofs_by_name['kind'].fields.append(
    _GENERATOROPTIONS_ARGVALUE.fields_by_name['bool_value'])
_GENERATOROPTIONS_ARGVALUE.fields_by_name['bool_value'].containing_oneof = _GENERATOROPTIONS_ARGVALUE.oneofs_by_name[
    'kind']
_GENERATOROPTIONS_ARGVALUE.oneofs_by_name['kind'].fields.append(
    _GENERATOROPTIONS_ARGVALUE.fields_by_name['string_value'])
_GENERATOROPTIONS_ARGVALUE.fields_by_name['string_value'].containing_oneof = _GENERATOROPTIONS_ARGVALUE.oneofs_by_name[
    'kind']

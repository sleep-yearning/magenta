...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=_b(
        ...
        '\t\x12\x10\n\x08\x66ilename\x18\x02 \x01(\t\x12\x18\n\x10reference_number\x18\x12 \x01('
        '\x03\x12\x17\n\x0f\x63ollection_name\x18\x03 \x01(\t\x12\x19\n\x11ticks_per_quarter\x18\x04 \x01('
        '\x05\x12G\n\x0ftime_signatures\x18\x05 \x03('
        '\x0b\x32..tensorflow.magenta.NoteSequence.TimeSignature\x12\x45\n\x0ekey_signatures\x18\x06 \x03('
        '\x0b\x32-.tensorflow.magenta.NoteSequence.KeySignature\x12\x36\n\x06tempos\x18\x07 \x03('
        '\x0b\x32&.tensorflow.magenta.NoteSequence.Tempo\x12\x34\n\x05notes\x18\x08 \x03('
        '\x0b\x32%.tensorflow.magenta.NoteSequence.Note\x12\x12\n\ntotal_time\x18\t \x01('
        '\x01\x12\x1d\n\x15total_quantized_steps\x18\x10 \x01(\x03\x12?\n\x0bpitch_bends\x18\n \x03('
        '\x0b\x32*.tensorflow.magenta.NoteSequence.PitchBend\x12G\n\x0f\x63ontrol_changes\x18\x0b \x03('
        '\x0b\x32..tensorflow.magenta.NoteSequence.ControlChange\x12=\n\npart_infos\x18\x0c \x03('
        '\x0b\x32).tensorflow.magenta.NoteSequence.PartInfo\x12@\n\x0bsource_info\x18\r \x01('
        '\x0b\x32+.tensorflow.magenta.NoteSequence.SourceInfo\x12I\n\x10text_annotations\x18\x0e \x03('
        '\x0b\x32/.tensorflow.magenta.NoteSequence.TextAnnotation\x12O\n\x13section_annotations\x18\x14 \x03('
        '\x0b\x32\x32.tensorflow.magenta.NoteSequence.SectionAnnotation\x12\x45\n\x0esection_groups\x18\x15 \x03('
        '\x0b\x32-.tensorflow.magenta.NoteSequence.SectionGroup\x12L\n\x11quantization_info\x18\x0f \x01('
        '\x0b\x32\x31.tensorflow.magenta.NoteSequence.QuantizationInfo\x12J\n\x10subsequence_info\x18\x11 \x01('
        '\x0b\x32\x30.tensorflow.magenta.NoteSequence.SubsequenceInfo\x12?\n\x11sequence_metadata\x18\x13 \x01('
        '\x0b\x32$.tensorflow.magenta.SequenceMetadata\x12I\n\x10instrument_infos\x18\x17 \x03('
        '\x0b\x32/.tensorflow.magenta.NoteSequence.InstrumentInfo\x1a\xc2\x02\n\x04Note\x12\r\n\x05pitch\x18\x01 '
        '\x01(\x05\x12>\n\npitch_name\x18\x0b \x01('
        '\x0e\x32*.tensorflow.magenta.NoteSequence.PitchName\x12\x10\n\x08velocity\x18\x02 \x01('
        '\x05\x12\x12\n\nstart_time\x18\x03 \x01(\x01\x12\x1c\n\x14quantized_start_step\x18\r \x01('
        '\x03\x12\x10\n\x08\x65nd_time\x18\x04 \x01(\x01\x12\x1a\n\x12quantized_end_step\x18\x0e \x01('
        '\x03\x12\x11\n\tnumerator\x18\x05 \x01(\x05\x12\x13\n\x0b\x64\x65nominator\x18\x06 \x01('
        '\x05\x12\x12\n\ninstrument\x18\x07 \x01(\x05\x12\x0f\n\x07program\x18\x08 \x01('
        '\x05\x12\x0f\n\x07is_drum\x18\t \x01(\x08\x12\x0c\n\x04part\x18\n \x01(\x05\x12\r\n\x05voice\x18\x0c \x01('
        '\x05\x1a\x45\n\rTimeSignature\x12\x0c\n\x04time\x18\x01 \x01(\x01\x12\x11\n\tnumerator\x18\x02 \x01('
        '\x05\x12\x13\n\x0b\x64\x65nominator\x18\x03 \x01('
        '\x05\x1a\xcc\x03\n\x0cKeySignature\x12\x0c\n\x04time\x18\x01 \x01(\x01\x12>\n\x03key\x18\x02 \x01('
        '\x0e\x32\x31.tensorflow.magenta.NoteSequence.KeySignature.Key\x12@\n\x04mode\x18\x03 \x01('
        '\x0e\x32\x32.tensorflow.magenta.NoteSequence.KeySignature.Mode\"\xb7\x01\n\x03Key\x12\x05\n\x01\x43\x10\x00'
        '\x12\x0b\n\x07\x43_SHARP\x10\x01\x12\n\n\x06\x44_FLAT\x10\x01\x12\x05\n\x01\x44\x10\x02\x12\x0b\n\x07'
        '\x44_SHARP\x10\x03\x12\n\n\x06\x45_FLAT\x10\x03\x12\x05\n\x01\x45\x10\x04\x12\x05\n\x01\x46\x10\x05\x12\x0b'
        ...
        '\x01(\x01\x12\x0c\n\x04\x62\x65nd\x18\x02 \x01(\x05\x12\x12\n\ninstrument\x18\x03 \x01('
        '\x05\x12\x0f\n\x07program\x18\x04 \x01(\x05\x12\x0f\n\x07is_drum\x18\x05 \x01('
        '\x08\x1a\x9a\x01\n\rControlChange\x12\x0c\n\x04time\x18\x01 \x01(\x01\x12\x16\n\x0equantized_step\x18\x07 '
        '\x01(\x03\x12\x16\n\x0e\x63ontrol_number\x18\x02 \x01(\x05\x12\x15\n\rcontrol_value\x18\x03 \x01('
        '\x05\x12\x12\n\ninstrument\x18\x04 \x01(\x05\x12\x0f\n\x07program\x18\x05 \x01('
        '\x05\x12\x0f\n\x07is_drum\x18\x06 \x01(\x08\x1a&\n\x08PartInfo\x12\x0c\n\x04part\x18\x01 \x01('
        '\x05\x12\x0c\n\x04name\x18\x02 \x01(\t\x1a\x32\n\x0eInstrumentInfo\x12\x12\n\ninstrument\x18\x01 \x01('
        '\x05\x12\x0c\n\x04name\x18\x02 \x01(\t\x1a\xac\x04\n\nSourceInfo\x12K\n\x0bsource_type\x18\x01 \x01('
        '\x0e\x32\x36.tensorflow.magenta.NoteSequence.SourceInfo.SourceType\x12O\n\rencoding_type\x18\x02 \x01('
        '\x0e\x32\x38.tensorflow.magenta.NoteSequence.SourceInfo.EncodingType\x12\x42\n\x06parser\x18\x03 \x01('
        '\x0e\x32\x32.tensorflow.magenta.NoteSequence.SourceInfo.Parser\"M\n\nSourceType\x12\x17\n'
        ...
        '\n\x0f\x61nnotation_type\x18\x03 \x01('
        '\x0e\x32\x42.tensorflow.magenta.NoteSequence.TextAnnotation.TextAnnotationType\"=\n\x12TextAnnotationType'
        '\x12\x0b\n\x07UNKNOWN\x10\x00\x12\x10\n\x0c\x43HORD_SYMBOL\x10\x01\x12\x08\n\x04\x42\x45\x41T\x10\x02\x1aY\n'
        '\x10QuantizationInfo\x12\x1b\n\x11steps_per_quarter\x18\x01 \x01('
        '\x05H\x00\x12\x1a\n\x10steps_per_second\x18\x02 \x01('
        '\x05H\x00\x42\x0c\n\nresolution\x1a\x45\n\x0fSubsequenceInfo\x12\x19\n\x11start_time_offset\x18\x01 \x01('
        '\x01\x12\x17\n\x0f\x65nd_time_offset\x18\x02 \x01('
        '\x01\x1a\x35\n\x11SectionAnnotation\x12\x0c\n\x04time\x18\x01 \x01(\x01\x12\x12\n\nsection_id\x18\x04 \x01('
        '\x03\x1aw\n\x07Section\x12\x14\n\nsection_id\x18\x01 \x01(\x03H\x00\x12\x46\n\rsection_group\x18\x02 \x01('
        '\x0b\x32-.tensorflow.magenta.NoteSequence.SectionGroupH\x00\x42\x0e\n\x0csection_type\x1a]\n\x0cSectionGroup'
        '\x12:\n\x08sections\x18\x01 \x03(\x0b\x32('
        '.tensorflow.magenta.NoteSequence.Section\x12\x11\n\tnum_times\x18\x02 \x01('
        '\x05\"\xff\x03\n\tPitchName\x12\x16\n\x12UNKNOWN_PITCH_NAME\x10\x00\x12\x0f\n\x0b\x46_FLAT_FLAT\x10\x01\x12'
        '\x0f\n\x0b\x43_FLAT_FLAT\x10\x02\x12\x0f\n\x0bG_FLAT_FLAT\x10\x03\x12\x0f\n\x0b\x44_FLAT_FLAT\x10\x04\x12'
        '\x0f\n\x0b\x41_FLAT_FLAT\x10\x05\x12\x0f\n\x0b\x45_FLAT_FLAT\x10\x06\x12\x0f\n\x0b\x42_FLAT_FLAT\x10\x07\x12'
        '\n\n\x06\x46_FLAT\x10\x08\x12\n\n\x06\x43_FLAT\x10\t\x12\n\n\x06G_FLAT\x10\n\x12\n\n\x06\x44_FLAT\x10\x0b'
...
_NOTESEQUENCE_QUANTIZATIONINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='steps_per_quarter', full_name='tensorflow.magenta.NoteSequence.QuantizationInfo.steps_per_quarter',
            index=0,
            number=1, type=5, cpp_type=1, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='steps_per_second', full_name='tensorflow.magenta.NoteSequence.QuantizationInfo.steps_per_second',
            index=1,
            number=2, type=5, cpp_type=1, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
...
_NOTESEQUENCE_SUBSEQUENCEINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='start_time_offset', full_name='tensorflow.magenta.NoteSequence.SubsequenceInfo.start_time_offset',
            index=0,
            number=1, type=1, cpp_type=5, label=1,
            has_default_value=False, default_value=float(0),
            message_type=None, enum_type=None, containing_type=None,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='end_time_offset', full_name='tensorflow.magenta.NoteSequence.SubsequenceInfo.end_time_offset',
            index=1,
            number=2, type=1, cpp_type=5, label=1,
            has_default_value=False, default_value=float(0),
            message_type=None, enum_type=None, containing_type=None,
...
_NOTESEQUENCE = _descriptor.Descriptor(
    ...
    nested_types=[_NOTESEQUENCE_NOTE, _NOTESEQUENCE_TIMESIGNATURE, _NOTESEQUENCE_KEYSIGNATURE, _NOTESEQUENCE_TEMPO,
                  _NOTESEQUENCE_PITCHBEND, _NOTESEQUENCE_CONTROLCHANGE, _NOTESEQUENCE_PARTINFO,
                  _NOTESEQUENCE_INSTRUMENTINFO, _NOTESEQUENCE_SOURCEINFO, _NOTESEQUENCE_TEXTANNOTATION,
                  _NOTESEQUENCE_QUANTIZATIONINFO, _NOTESEQUENCE_SUBSEQUENCEINFO, _NOTESEQUENCE_SECTIONANNOTATION,
...
_NOTESEQUENCE_TEXTANNOTATION.fields_by_name[
    'annotation_type'].enum_type = _NOTESEQUENCE_TEXTANNOTATION_TEXTANNOTATIONTYPE
...
_NOTESEQUENCE_QUANTIZATIONINFO.fields_by_name['steps_per_quarter'].containing_oneof = \
    _NOTESEQUENCE_QUANTIZATIONINFO.oneofs_by_name['resolution']
_NOTESEQUENCE_QUANTIZATIONINFO.oneofs_by_name['resolution'].fields.append(
    _NOTESEQUENCE_QUANTIZATIONINFO.fields_by_name['steps_per_second'])
_NOTESEQUENCE_QUANTIZATIONINFO.fields_by_name['steps_per_second'].containing_oneof = \
    _NOTESEQUENCE_QUANTIZATIONINFO.oneofs_by_name['resolution']
...
_NOTESEQUENCE_SECTION.fields_by_name['section_id'].containing_oneof = _NOTESEQUENCE_SECTION.oneofs_by_name[
    'section_type']
_NOTESEQUENCE_SECTION.oneofs_by_name['section_type'].fields.append(
    _NOTESEQUENCE_SECTION.fields_by_name['section_group'])
_NOTESEQUENCE_SECTION.fields_by_name['section_group'].containing_oneof = _NOTESEQUENCE_SECTION.oneofs_by_name[
    'section_type']
